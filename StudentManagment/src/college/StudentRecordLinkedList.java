	...
	public static void main(String[] args) {
     ...
     StudentRecordManagement hr = new StudentRecordManagement();
        Record record = new Record();    
            ...
            record.setIdNumber(17854);
           
			record.setContactNumber(3419);
        ...
        do {
            ...
            case 1:
                ...
                @SuppressWarnings("unused") int idNumber = input.nextInt();
 
                // Display message
                System.out.print(
                    "What is the Student contact Number ? ");
 
                @SuppressWarnings("unused") int contactNumber = input.nextInt();
                input.nextLine();
                ...
                @SuppressWarnings("unused") String name = input.nextLine();
